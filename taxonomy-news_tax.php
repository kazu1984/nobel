...
<div class="l-sub-page l-inner">
  ...
  <div class="l-sub-page__main">
    <div class="p-news">
      <?php
      $selected_term = get_queried_object()->name;
      $selected_term_id = get_queried_object()->term_id;
      ?>
      <ul class="p-news__categories">
        <li class="p-news__category">
          <a href="<?php echo esc_url(get_post_type_archive_link('news')); ?>" class="c-button c-button--grey">すべて</a>
        </li>
        ...
        <?php foreach ($terms as $term) { ?>
          <li class="p-news__category">
            <a href="<?php echo get_term_link($term->slug, 'news_tax') ?>" class="c-button c-button--grey <?php echo ($selected_term == $term->name) ? "is-active" : ""; ?>">
              <?php echo $term->name ?>
            </a>
          </li>
        <?php } ?>
      ...
      <?php if (have_posts()) : ?>
        ...
        <ul class="p-news__list js-load" data-count="<?php echo $count; ?>" data-post-type="news" data-term="<?php echo $selected_term_id ?>">
